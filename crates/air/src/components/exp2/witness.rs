...
pub struct Exp2ClaimGenerator {
    /// The raw trace data for Exp2 operations.
    pub inputs: Exp2TraceTable,
}

impl Exp2ClaimGenerator {
    /// Creates a new `Exp2ClaimGenerator` with the given `Exp2TraceTable`.
    ...
    ) -> Result<(Exp2Claim, Exp2InteractionClaimGenerator), TraceError> {
...
pub struct Exp2InteractionClaimGenerator {
...
impl Exp2InteractionClaimGenerator {
    ...
    pub fn write_interaction_trace(
        ...
        lookup_elements: &exp2::Exp2LookupElements, // Specific randomness for Exp2 LUT
    ) -> InteractionClaim {
